...
const affiches = [
  {
    ...
    description: "Visuel principal du tournoi pour la communication générale.",
    format: "A3 / HD",
  },
  {
    id: "A2",
        ...
        {affiches.map((affiche) => (
          <Card key={affiche.id} className="overflow-hidden">
            ...
            <CardContent className="space-y-2 pt-0">
              <p className="text-sm text-muted-foreground">{affiche.description}</p>
              <p className="text-xs text-muted-foreground/80">Format conseillé: {affiche.format}</p>
            </CardContent>
          </Card>
        ))}
      </section>
