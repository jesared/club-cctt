    ...
    <main className="space-y-6">
      ...
      <Card className="border-border bg-card shadow-sm transition-colors duration-200 hover:shadow-md">
        <CardHeader>
          ...
          <CardDescription>Configurez vos notifications et informations de profil.</CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-sm text-muted-foreground">Le formulaire de paramètres sera intégré ici.</p>
        </CardContent>
      </Card>
    </main>
  );
