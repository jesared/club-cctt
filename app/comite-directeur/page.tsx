...
export default async function ComiteDirecteurPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12 space-y-14">
      {/* TITRE */}
      <header className="rounded-xl border bg-card/70 p-8 shadow-sm dark:rounded-none dark:border-primary/45 dark:bg-card dark:shadow-[0_0_26px_color-mix(in_oklab,var(--primary)_20%,transparent)]">
      ...
      {/* BUREAU */}
      <section>
        <h2 className="text-3xl font-semibold mb-8 dark:font-mono dark:uppercase dark:tracking-[0.08em]">Bureau</h2>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {data.bureau.map((personne) => (
            <Card key={personne.nom} className="border-l-4 border-l-primary dark:rounded-none dark:border-primary/45 dark:border-l-primary dark:bg-card/90 dark:shadow-[0_0_18px_color-mix(in_oklab,var(--primary)_18%,transparent)]">
      ...
      {/* MEMBRES */}
      <section>
        <h2 className="text-3xl font-semibold mb-8 dark:font-mono dark:uppercase dark:tracking-[0.08em]">Membres du comité</h2>
      ...
      {/* SALARIÉS */}
      <section>
        <h2 className="text-3xl font-semibold mb-8 dark:font-mono dark:uppercase dark:tracking-[0.08em]">Salariés diplômés</h2>
