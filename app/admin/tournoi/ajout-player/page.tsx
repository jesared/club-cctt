...
export default async function AdminTournoiAjoutPlayerPage() {
  ...
  return (
    <TournamentAdminPage
      ...
      description="Préparation des champs utiles pour une inscription sur place cohérente avec les tableaux officiels."
      activeHref="/admin/tournoi/ajout-player"
      items={[
        "Saisie identité, licence, club et classement.",
        "Affectation guidée vers les tableaux A à P.",
      ...
      <section className="rounded-xl border bg-white p-6 shadow-sm space-y-4">
        ...
        <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
          {tournamentTables.map((table) => (
            <div key={table.table} className="rounded-lg border border-gray-200 p-3 text-sm">
