    ...
    <main className="space-y-6">
      ...
      <Card className="border-border bg-card shadow-sm transition-colors duration-200 hover:shadow-md">
        <CardHeader>
          ...
          <CardDescription>Le suivi détaillé de vos paiements sera affiché ici.</CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-sm text-muted-foreground">Aucune transaction disponible pour le moment.</p>
        </CardContent>
      </Card>
    </main>
  );
